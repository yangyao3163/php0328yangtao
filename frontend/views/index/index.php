...
<div class="topnav">
    <div class="topnav_bd w1210 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <li>您好，欢迎来到京西！
                    [<a href="<?=Yii::getAlias('@web')?>/member/login">登录</a>]
                    [<a href="<?=Yii::getAlias('@web')?>/member/register">免费注册</a>]
                </li>
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd">
                <?php foreach($model as $a):?>
                    <div class="cat item1">
                        <h3><a href="<?=Yii::getAlias('@web')?>/index/list?id=<?=$a->id?>"><?=$a->name?></a> <b></b></h3>
                        <div class="cat_detail">
                            <?php foreach(\backend\models\GoodsCategory::find()->where(['=','parent_id',$a->id])->all() as $b):?>

                                <dl class="dl_1st">
                                    <dt><a href="<?=Yii::getAlias('@web')?>/index/list?id=<?=$b->id?>"><?=$b->name?></a></dt>
                                    <dd>
                                        <?php foreach(\backend\models\GoodsCategory::find()->where(['=','parent_id',$b->id])->all() as $c):?>
                                            <a href="<?=Yii::getAlias('@web')?>/index/list?id=<?=$c->id?>"><?=$c->name?></a>
                                        <?php endforeach;?>
                                    </dd>
                                </dl>
                            <?php endforeach;?>
...
<div class="guide w1210 bc mt15">
    ...
    <div class="guide_content fl">
        ...
        <div class="guide_wrap">
            ...
            <div class="crazy">
                <ul>
                    <?php foreach (\backend\models\Goods::find()->limit(3)->all() as $mo): ?>
                    <li>
                        <dl>
                            <dt><a href="/index/goods?id=<?=$mo->id?>"><img src="http://admin.yiishop.com<?= $mo->logo?>" alt="" /></a></dt>
                            <dd><a href="/index/goods?id=<?=$mo->id?>"><?= $mo->name?></a></dd>
                            <dd><span>售价：</span><strong><?= $mo->shop_price?></strong></dd>
                        </dl>
                    </li>
                    <?php endforeach; ?>
                </ul>
...
<!--                        <li>-->
<!--                            <dl>-->
<!--                                <dt><a href=""><img src="http://admin.yiishop.com--><?//= $mo->logo?><!--" alt="" /></a></dt>-->
<!--                                <dd><a href="">--><?//= $mo->name?><!--</a></dd>-->
<!--                                <dd><span>售价：</span><strong>--><?//= $mo->shop_price?><!--</strong></dd>-->
<!--                            </dl>-->
<!--                        </li>-->
<!--                    --><?php //endforeach; ?>
